...
export const OPTAVIA_RANKS = [
  ...
  { rank: 2, title: "Senior Coach" },
  { rank: 3, title: "Manager" },
  { rank: 4, title: "Associate Director" },
  { rank: 5, title: "Director" },
  { rank: 6, title: "Executive Director" },
  { rank: 7, title: "National Director" },
  { rank: 8, title: "Global Director" },
  { rank: 9, title: "Presidential Director" },
  { rank: 10, title: "Integrated Executive Director" },
  { rank: 11, title: "Integrated National Director" },
  { rank: 12, title: "Integrated Global Director" },
  { rank: 13, title: "Integrated Presidential Director" },
]
