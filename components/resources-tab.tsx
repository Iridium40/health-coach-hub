...
export function ResourcesTab({ userData, setUserData, onSelectModule }: ResourcesTabProps) {
  ...
  const categoryOrder: ModuleCategory[] = ["Pre Launch (New Coaches)", "Launch Week", "First 30 Days", "Growing to Senior Coach", "Using Connect for Business Success", "Getting Started", "Business Building", "Client Support", "Training"]
