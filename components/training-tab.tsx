...
export const TrainingTab = memo(function TrainingTab({ userData, setUserData, onSelectModule, modules }: TrainingTabProps) {
  ...
  const categories = useMemo(() => {
    ...
    const categoryOrder: string[] = ["Pre Launch (New Coaches)", "Launch Week", "First 30 Days", "Growing to Senior Coach", "Using Connect for Business Success", "ED to FIBC", "Leadership Development", "Getting Started", "Client Support", "Business Building"]
